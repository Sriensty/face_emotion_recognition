...
ellipse_filename = '../fddb/FDDB-folds/FDDB-fold-10-ellipseList.txt'
img_folder = '../fddb/FDDB-folds/FDDB-fold-10.txt'
rect_filename = '../fddb/FDDB-folds/FDDB-fold-10-rectList.txt'
...
i = 0
while i < len(lines):
	img_file = '../fddb/originalPics/' + lines[i] + '.jpg'
	...
	for j in range(num_faces):
		...
		f.write(text.encode('utf-8'))  # 将字符串编码为字节
